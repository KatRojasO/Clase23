...
function setearDatos(){
    ...
    if(seleccionado != null && seleccionado >= 0 && seleccionado != undefined){
        var elCli = clientes[seleccionado];

        document.getElementById('nombre').value = elCli.nombre;
        document.getElementById('apellidos').value = elCli.apellidos;
        document.getElementById('documento').value = elCli.documento;
        document.getElementById('tipoDocumento').value = elCli.tipoDocumento;
        document.getElementById('telefono').value = elCli.telefono;
        document.getElementById('correo').value = elCli.correo;
